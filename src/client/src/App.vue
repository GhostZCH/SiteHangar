...
<template>
  <div>
    ...
    />
    <AppNav
      v-if="!route.meta.hideHeader && route.path !== '/' && route.name !== 'module' && route.name !== 'detail' && route.name !== 'info' && route.name !== 'graph'"
    ...
    <MobileNav
      ...
      :class="{ 'mobile-hidden': isMobile && !barsVisible }"
    />
    <footer v-if="site.icp && route.name !== 'graph'" class="footer" :style="footerMargin">
